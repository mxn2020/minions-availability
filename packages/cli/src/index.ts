...
/**
 * @minions-availability/cli — CLI for Minions Availability
 *
...
import { customTypes } from '@minions-availability/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Availability'));
        console.log(chalk.dim('Availability snapshots, slot states, and change detection for tent reservations'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-availability/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-availability/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-availability')}`);
